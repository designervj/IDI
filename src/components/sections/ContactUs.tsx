        ...
        <div className="grid md:grid-cols-2 gap-12">
          ...
          <div className="space-y-8">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h4 className="font-semibold text-brand-orange">Address</h4>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <h4 className="font-semibold text-brand-orange">Email</h4>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <h4 className="font-semibold text-brand-orange">Phone</h4>
          ...
          <form className="space-y-6 bg-white rounded-xl p-8 shadow-lg">
            ...
            <button
              type="submit"
              className="w-full bg-brand-orange hover:bg-[#c26200] text-white font-semibold py-3  transition-colors duration-300"
              style={{borderRadius:"6px"}}
            >
              Send Message
            </button>
