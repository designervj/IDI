    ...
    <section className="relative bg-[#F8F7F2] py-20">
      <div className="max-w-6xl mx-auto px-4 relative z-10">
        ...
        <div className="mt-10 text-center text-gray-700 text-lg max-w-3xl mx-auto">
          <p className="font-semibold text-brand-blue text-xl">
        ...
        <div className="flex items-center justify-center gap-8 mt-10">
          <button
            ref={prevRef}
            className="bg-brand-orange hover:bg-brand-orange/90 transition-all duration-300 w-10 h-10 flex items-center justify-center rounded-full shadow-md"
          >
