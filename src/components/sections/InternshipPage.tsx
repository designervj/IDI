    ...
    <section className="relative bg-white py-20 min-h-[70vh]">
      ...
      <div className="max-w-6xl mx-auto px-4 relative z-10">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 border-t-4 border-brand-orange">
            ...
            <form className="space-y-4">
              <div>
                ...
                <input type="text" className="w-full border border-gray-300 rounded-2xl px-4 py-2 focus:ring-2 focus:ring-brand-blue focus:outline-none" placeholder="John Doe" />
              </div>
              <div>
                <label className="block text-gray-700 font-medium mb-1">Email Address</label>
                <input type="email" className="w-full border border-gray-300 rounded-2xl px-4 py-2 focus:ring-2 focus:ring-brand-blue focus:outline-none" placeholder="john@example.com" />
              </div>
              <div>
                <label className="block text-gray-700 font-medium mb-1">Area of Interest</label>
                <select className="w-full border border-gray-300 rounded-2xl px-4 py-2 focus:ring-2 focus:ring-brand-blue focus:outline-none bg-white">
              ...
              <button type="button" className="w-full bg-brand-orange hover:bg-[#c26200] text-white font-bold py-3 rounded-2xl transition-colors duration-300 mt-4">
                Submit Application
              </button>
            </form>
          </div>
